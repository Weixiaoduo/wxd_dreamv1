...
<div id="pt" class="bm cl">
	...
	<div class="z">
<iframe width="120" height="22" frameborder="0" allowtransparency="true" marginwidth="0" marginheight="0" scrolling="no" border="0" src="http://widget.weibo.com/relationship/followbutton.php?language=zh_cn&width=120&height=22&uid=5051857418&style=2&btn=red&dpc=1"></iframe>
</div>
...
<div class="newsblue">
	...
	<div id="nleft">
        ...
        <div id="topic">
        	<h2><strong>热门分享</strong><span><a href="#">更多</a> >></span></h2>
	...
	<div id="center">
        ...
        <div id="Tab1">
            <div class="Menubox">
                <ul>
                    <li id="one1" onmouseover="setTab('one',1,3)"  class="hover">最新回复</li>
                    <li id="one2" onmouseover="setTab('one',2,3)" >最新主题</li>
                    <li id="one3" onmouseover="setTab('one',3,3)">社区精华</li>
                    <li id="email"><a href="#" target="_blank" title="邮件订阅"><img src="{IMGDIR}/emailDyue.jpg" /></a></li>
                </ul>
            </div>
    ...
    <div id="nright">
		<div id="tongjix">
     	  <ul><iframe allowtransparency="true" frameborder="0" width="180" height="36" scrolling="no" src="http://tianqi.2345.com/plugin/widget/index.htm?s=3&z=2&t=0&v=0&d=1&bd=0&k=000000&f=&q=0&e=0&a=1&c=54511&w=180&h=36&align=left"></iframe></ul>
          <ol>
          <strong><a onclick="showWindow('nav', this.href, 'get', 0)" href="forum.php?mod=misc&amp;action=nav"> <img src="template/wxd_dreamv1/wxd_img/button_01.jpg"></a><a href="./home.php?mod=spacecp" target="_blank"><img src="template/wxd_dreamv1/wxd_img/button_02.jpg"></a></strong>
          
          </ol>
   		</div>
        <div id="xuanshang">
        	<h3><strong>互助问答</strong><span><a href="#">我要提问</a> >></span></h3>
            <ul>
